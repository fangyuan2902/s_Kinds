...
//    let width: CGFloat = 50
    ...
    fileprivate func setupSubviews() {
        ...
        timeBtn.addTarget(self, action: #selector(AdsView.jumpAD), for: .touchUpInside)
    ...
    fileprivate func changeStyle() {
        ...
        case .round:
            ...
            self.timeBtn.layer.cornerRadius = 50 / 2
    ...
    public func start() {
        if #available(iOS 10.0, *) {
            ...
            timer = Timer.scheduledTimer(timeInterval: 1, target: self, selector: #selector(AdsView.countDown), userInfo: nil, repeats: true)
        }
