...
typealias AlertViewClickButtonBlock = ((_ alertView:AlertView,_ buttonIndex:Int)->Void)?
...
class AlertView : UIView {
    ...
    public var delegate : AlertViewDelegate?//weak
    public var animationOption:AlertAnimationOptions = .none
    // background visual
    ...
    private var _clickButtonBlock:AlertViewClickButtonBlock
    ...
    public convenience init(title:String,message:String?,delegate:AlertViewDelegate?,cancelButtonTitle:String?,otherButtonTitles:[String]){
    ...
    open class func show(title:String,message:String?,cancelButtonTitle:String?,otherButtonTitles:String ... ,clickButtonBlock:AlertViewClickButtonBlock){
        let alertView = AlertView(title: title, message: message, delegate: nil, cancelButtonTitle: cancelButtonTitle, otherButtonTitles: otherButtonTitles)
        alertView._clickButtonBlock = clickButtonBlock
        alertView.show()
    }
    
    open class func show(title:String,message:String?,cancelButtonTitle:String?,otherButtonTitle:String,clickButtonBlock:AlertViewClickButtonBlock){
        
        let alertView = AlertView(title: title, message: message, delegate: nil, cancelButtonTitle: cancelButtonTitle, otherButtonTitles: [otherButtonTitle])
        alertView._clickButtonBlock = clickButtonBlock
        alertView.show()
    }
